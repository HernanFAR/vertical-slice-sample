...
namespace VSlices.CrossCutting.StreamPipeline.Logging.MessageTemplates;
...
{
    /// <summary>
    /// Invoked when the stream pipeline starts
    /// </summary>
    string Start { get; }

    /// <summary>
    /// Invoked when the stream handler executes with failure
    /// </summary>
    string FailureEnd { get; }

    /// <summary>
    /// Invoked when the stream handler executes correctly
    /// </summary>
...
internal sealed class EnglishLoggingMessageTemplate : ILoggingMessageTemplate
{
    ...
    /// <inheritdoc />
    public string SuccessEnd => "UTC {0} - Finished handling of {1}, result: Success | Input: {2}";
}
...
internal sealed class SpanishLoggingMessageTemplate : ILoggingMessageTemplate
{
    ...
    /// <inheritdoc />
    public string SuccessEnd => "UTC {0} - Ejecución de {1} terminada, result: Exito | Entrada: {2}";
}